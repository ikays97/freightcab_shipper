...
class PastShipmentsPage extends StatefulWidget {
  @override
  _PastShipmentsPageState createState() => _PastShipmentsPageState();
}

class _PastShipmentsPageState extends State<PastShipmentsPage> {
    ...
    final result = await graphqlClient.query(
      QueryOptions(
        ...
        variables: UserShipmentsArguments(
          states: [
            ShipmentStatusEnum.rejectedByShipper,

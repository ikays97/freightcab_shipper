...
class MyExpansionTile extends StatefulWidget {
  ...
  const MyExpansionTile({
    ...
    this.childrenPadding = const EdgeInsets.all(6),
...
class InverseExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const InverseExpansionTile({
    Key key,
    this.leading,
    @required this.title,
    this.subtitle,
...
//  final Widget trailing;
  ...
  @override
  _InverseExpansionTileState createState() => _InverseExpansionTileState();
}

class _InverseExpansionTileState extends State<InverseExpansionTile>
    with SingleTickerProviderStateMixin {
  static final Animatable<double> _easeOutTween =
      CurveTween(curve: Curves.easeOut);
  static final Animatable<double> _easeInTween =
